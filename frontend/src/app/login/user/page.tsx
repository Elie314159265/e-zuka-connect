...
export default function UserLoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        let apiUrl = `${apiBaseUrl}/api/token/`;
    ...
    return (
        <AuthPageLayout>
            <div className="text-center mb-8">
                ...
                <p className="text-gray-600">お客様ログイン</p>
            </div>
            ...
            <p className="text-center text-gray-600 text-sm mt-8">
                アカウントをお持ちでないですか？ <Link href="/register/user" className="font-bold text-blue-600 hover:text-blue-800">新規登録</Link>
            </p>
        </AuthPageLayout>
    );
};
